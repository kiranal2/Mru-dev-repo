                  ...
                  <div className="bg-white overflow-hidden">
                    ...
                    <div className="bg-[#EFEFEF] rounded-xl rounded-tl-none px-6 py-4">
                      <div className="flex items-center space-x-2">
                        <FileText className="w-6 h-6 text-[#0A3B77]" />
    ...
    >
                        ...
                        <Tooltip delayDuration={150}>
                          <TooltipTrigger asChild>
                            <button
                              ...
                              onClick={() => setIsHistoryOpen(true)}
                              aria-label="History"
                              className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-[#D2D2D2] bg-white text-[#0A3B77] hover:bg-[#D1ECFF] hover:border-[#0A3B77] transition-colors"
                            >
                              <Clock size={14} />
                            </button>
                          </TooltipTrigger>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        activeChips.some((activeChip) => activeChip.text === chip)
                          ? "bg-[#0A3B77] text-white border-[#0A3B77]"
                          : "bg-[#F7FAFC] text-[#6B7280] border-[#E5E7EB] hover:border-[#0A3B77] hover:bg-white hover:text-[#0A3B77]"
                      )}
      ...
      >
        <div className="border-b border-[#E5E7EB] px-4 py-3 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2">
            <Clock className="w-5 h-5 text-[#0A3B77]" />
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-4">
          {isLoadingSessions ? (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              <div className="w-8 h-8 border-2 border-[#0A3B77] border-t-transparent rounded-full animate-spin mb-3" />
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              {onRetrySessions && (
                <button
                  ...
                  className="mt-4 inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-[#0A3B77] border border-[#D2D2D2] rounded-lg hover:bg-[#E8F4FD] transition-colors"
                >
            ...
            <ul className="space-y-3">
              {chatSessions.map((s) => (
                <li
                  ...
                  className={cn(
                    "rounded-xl border border-[#E5E7EB] bg-[#F8FAFC] p-3 text-left transition-colors hover:border-[#CBD5E1] hover:bg-[#F1F5F9] cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#0A3B77] focus:ring-offset-1",
                    activeSessionId === s.session_id && "border-[#0A3B77] bg-[#E8F4FD]"
                  )}
                >
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-xs font-medium text-[#0A3B77] truncate">
                      {s.title || "Untitled"}
                    </span>
