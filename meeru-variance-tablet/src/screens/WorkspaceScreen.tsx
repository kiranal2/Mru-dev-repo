      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 20, paddingBottom: 100 }}>
        ...
        <View className="mt-4 mb-5 flex-row items-start justify-between">
          <View className="flex-1">
            <Text className="text-[11px] tracking-wider uppercase text-muted">My Workspace</Text>
        ...
        {/* Live pins (2 × 2 grid) */}
        <Text className="text-[10px] font-semibold tracking-wider uppercase text-muted mb-2">Live Pins</Text>
        <View className="flex-row flex-wrap gap-3 mb-6">
          {LIVE_PINS.map((p, i) => {
            ...
            return (
              ...
              >
                <Text className="text-[10px] tracking-wider uppercase text-muted font-semibold">{p.label}</Text>
        ...
        {/* Watchlist */}
        <Text className="text-[10px] font-semibold tracking-wider uppercase text-muted mb-2">Watchlist</Text>
        ...
        {/* Quick access tiles */}
        <Text className="text-[10px] font-semibold tracking-wider uppercase text-muted mb-2">Jump to workbench</Text>
        <View className="flex-row flex-wrap gap-3">
          <Pressable
            ...
            style={{ width: '48%', borderWidth: 1, borderColor: '#E2E8F0' }}
          >
            <Icon.Chart color="#1E40AF" size={22} />
            <Text className="text-sm font-semibold text-ink mt-2">Variance</Text>
            <Text className="text-[11px] text-muted">Performance · Margin · Flux</Text>
          </Pressable>
          <Pressable
            ...
            style={{ width: '48%', borderWidth: 1, borderColor: '#E2E8F0' }}
          >
            <Icon.Calendar color="#1E40AF" size={22} />
            <Text className="text-sm font-semibold text-ink mt-2">Close</Text>
            <Text className="text-[11px] text-muted">Day 4 / 5 · 2 blockers</Text>
          </Pressable>
        </View>
      </ScrollView>
    </SafeAreaView>
