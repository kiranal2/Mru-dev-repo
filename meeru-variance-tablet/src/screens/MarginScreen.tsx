  ...
  return (
    <Svg width={width} height={H + 40}>
      ...
      {rows.map((r, i) => {
        ...
        const color =
          r.kind === 'start' || r.kind === 'end' ? '#1E40AF'
          : r.kind === 'pos' ? '#16A34A'
          : '#DC2626';
            ...
            >
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                ...
                <Pressable onPress={() => askAgent('Walk me through the gross margin bridge')} hitSlop={6}>
                  <Icon.Sparkle color="#1E40AF" size={14} />
                </Pressable>
              </View>
                      ...
                      <View style={{ height: 6, backgroundColor: '#F1F5F9', borderRadius: 3, overflow: 'hidden' }}>
                        <View
                          style={{
                            ...
                            maxWidth: '100%' as any,
                            height: 6, backgroundColor: '#1E40AF', borderRadius: 3,
                          }}
                        />
                      </View>
                    </View>
        ...
        <ScrollView style={{ flex: 1 }}>
          <View style={pageStyle}>
            ...
            {MARGIN_SENSITIVITY.map((s, i) => {
              ...
              const probColor = s.probability >= 60 ? '#16A34A' : s.probability >= 40 ? '#1E40AF' : '#D97706';
              return (
                <View
                  key={i}
                  style={{
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <Pressable
                      ...
                      style={{
                        ...
                        backgroundColor: '#EFF6FF', flexDirection: 'row', gap: 4, alignItems: 'center',
                      }}
                    >
                      <Icon.Sparkle color="#1E40AF" size={11} />
                      <Text style={{ fontSize: 10, fontWeight: '600', color: '#1E40AF' }}>Run</Text>
                    </Pressable>
                  </View>
