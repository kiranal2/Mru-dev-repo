    ...
    >
      ...
      <View className="px-4 py-2.5 flex-row items-center gap-2 bg-brand-tint/40">
        ...
        <Pressable onPress={reset} className="ml-2 flex-row items-center gap-1">
          <Icon.Pencil size={12} color="#F16922" />
        ...
        <View className="flex-row items-center gap-1 ml-3">
          <HeaderChip
            icon={<Icon.ChevDown size={12} color={minimized ? '#F16922' : '#A3A3A3'} />}
          ...
          />
          <HeaderChip
            icon={<Icon.Pin size={12} color={pinned ? '#F16922' : '#A3A3A3'} />}
            label="Pin"
            active={pinned}
            onPress={() => {
              const next = !pinned;
          ...
          />
          <HeaderChip
            icon={<Icon.Star size={12} color={favorited ? '#F16922' : '#A3A3A3'} fill={favorited ? '#F16922' : 'none'} />}
            label="Favorite"
            active={favorited}
          ...
          />
          <HeaderChip
            icon={fullsize ? <Icon.Minimize size={12} color="#F16922" /> : <Icon.Maximize size={12} color="#A3A3A3" />}
