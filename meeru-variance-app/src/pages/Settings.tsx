      ...
      <div className="max-w-[720px] mx-auto">
        ...
        <Card className="p-5 mb-4">
          ...
          <div className="flex items-center gap-4 mt-2">
            <div className="w-14 h-14 rounded-full text-white grid place-items-center text-[18px] font-semibold" style={{ background: 'linear-gradient(135deg,#E8C5A8,#B64D1D)' }}>{user?.init}</div>
            <div>
