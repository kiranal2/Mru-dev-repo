    ...
    <>
      ...
      <div className="xl:hidden px-4 py-1.5 space-y-1.5 min-w-0 overflow-hidden">
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto">
          ...
          {/* View pills — IS/BS/CF on phone, full labels on tablet */}
          <div className="flex items-center rounded-md border border-slate-200 bg-white p-0.5 shrink-0">
            {(["is", "bs", "cf"] as const).map((view) => {
              const short = { is: "IS", bs: "BS", cf: "CF" };
              const full = { is: "Income Stmt", bs: "Balance Sheet", cf: "Cash Flow" };
              return (
                <button
                  key={view}
                  ...
                  className={cn(
                    ...
                    activeView === view ? "bg-primary text-white" : "text-slate-400"
                  )}
                >
                  <span className="md:hidden">{short[view]}</span>
