...
import { ProcessStageHeader } from "./process-stage-header";
import { ProcessDesignPanel } from "./process-design-panel";
import { ProcessSimulationPanel } from "./process-simulation-panel";
import { ProcessNarrativePanel } from "./process-narrative-panel";
